...
"""Черно-белый график"""
def Plotting_bw (x, y, name_x, name_y, name_graph, label, filename):
    fig = plt.figure()
...
"""ДВЕ кривые на одном графике, черно-белый."""
def Plotting_bw2(x1, y1, x2, y2, name_x, name_y, name_graph, label1, label2, filename):
    fig = plt.figure()
    plt.plot(x1, y1, label = label1, color = "k")
    plt.plot(x2, y2, label = label2, alpha=0.4, color = "k")
    plt.xlabel(name_x, fontsize = 13)
    plt.ylabel(name_y, fontsize = 13)
    plt.title(name_graph, fontsize = 13)
    plt.legend()
...
"""ТРИ кривые на одном графике, черно-белый."""
def Plotting_bw3(x1, y1, x2, y2, x3, y3, name_x, name_y, name_graph, label1, label2, label3, filename):
    fig = plt.figure()
    plt.plot(x1, y1, label = label1, color = "k")
    plt.plot(x2, y2, label = label2, alpha=0.4, color = "k")
    plt.plot(x3, y3, label = label3, alpha=0.4, linestyle = "--", color = "k")
    plt.xlabel(name_x, fontsize = 13)
    plt.ylabel(name_y, fontsize = 13)
    plt.title(name_graph, fontsize = 13)
    plt.legend()
